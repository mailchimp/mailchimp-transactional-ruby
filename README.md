...
```shell
gem install ./MailchimpTransactional-1.0.22.gem
```
(for development, run `gem install --dev ./MailchimpTransactional-1.0.22.gem` to install the development dependencies)
